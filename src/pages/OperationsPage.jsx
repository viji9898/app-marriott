...
const stabilisedMetrics = [
  [
    "USD 155",
    "Average daily rate",
    "Pricing consistent with the resort’s international positioning.",
  ],
  ["75%", "Occupancy", "Sustained demand beyond the opening period."],
  [
    "38%",
    "GOP margin",
    "Revenue converted into operating profit at asset level.",
  ],
];
...
const operatingLessons = [
  [
    "Mobilise the operator before completion",
    "Department heads can identify practical issues while they remain relatively inexpensive to correct.",
  ],
  [
    "Protect rate positioning",
    "Opening discounts can generate occupancy while weakening the long-term commercial position.",
  ],
  [
    "Use low occupancy as extended commissioning",
    "A controlled opening allows systems and teams to develop before peak demand.",
  ],
  [
    "Separate peak occupancy from stabilisation",
    "A full hotel tests capacity; sustained occupancy, ADR and margin prove the business.",
  ],
  [
    "Design food and beverage around operation",
    "Kitchen planning, service routes and waste control have a direct effect on GOP.",
  ],
  [
    "Treat feedback as operating data",
    "Repeated guest observations provide a practical quality-control system.",
  ],
  [
    "Maintain active asset management",
    "An international operator does not replace ownership oversight of performance, capital and strategy.",
  ],
];
  ...
  return (
    <main className="operations-page">
      <section className="operations-hero">
        ...
        <div className="page-width operations-hero-content">
          ...
          <div className="operations-hero-copy">
            <p>
              Physical completion did not establish the value of the
              development. The hotel needed to open reliably, build demand,
              protect its rate position and demonstrate sustainable operating
              margins.
            </p>
            <p>
              Marriott mobilised an experienced pre-opening team while the
              project retained active oversight through commissioning and the
              initial operating period. The hotel subsequently stabilised at 75%
              occupancy, USD 155 average daily rate and a 38% gross operating
              profit margin.
            </p>
          </div>
        </div>
        <div className="operations-signals">
          <div className="page-width">
            <span>
              <strong>198</strong> Keys
            </span>
            <span>
              <strong>75%</strong> Occupancy
            </span>
            <span>
              <strong>USD 155</strong> ADR
            </span>
            <span>
              <strong>38%</strong> GOP margin
            </span>
          </div>
        </div>
      </section>
      ...
      <section className="operations-transition page-width">
        <OperationsHeading
          number="01"
          label="FROM DEVELOPMENT TO OPERATION"
          title="The handover began before construction ended."
        />
        <p className="operations-intro">
          Marriott’s operating team entered while construction, procurement and
          commissioning were still underway. Practical changes could therefore
          be resolved before guests arrived.
        </p>
        <div className="operations-transition-table">
          <div className="operations-table-head">
            <span>Development activity</span>
            <span>Operating activity</span>
          </div>
      ...
      <section className="operations-mobilisation">
        <div className="page-width operations-mobilisation-grid">
          <div>
            <OperationsHeading
              number="02"
              label="MARRIOTT MOBILISATION"
              title="An experienced team was assembled before opening."
            />
            <p>
              Department heads reviewed operational areas before opening,
              allowing equipment positions, workflows, storage and service
              requirements to be tested against daily operating needs.
            </p>
            <p>
              The pre-opening team was intended to remain through the early
              trading cycle, providing continuity from opening conditions to
              stable operation.
            </p>
          </div>
          <div className="operations-role-grid">
            {mobilisationRoles.map((role, index) => (
              <span key={role}>
      ...
      <section className="operations-section page-width">
        <OperationsHeading
          number="03"
          label="PREPARING THE HOTEL TO TRADE"
          title="Every department required its own operating system."
        />
        <div className="operations-section-copy">
          <p>
            Opening preparation extended beyond recruitment. Marriott procedures
            had to be configured for the specific property while operating
            equipment was received, checked, stored and allocated within an
        ...
        <div className="page-width operations-positioning-grid">
          <div>
            <OperationsHeading
              ...
              title="Rate discipline took priority over occupancy alone."
            />
            <p>
              The central question was how quickly occupancy could be
              established without weakening the resort’s long-term rate
              position.
            </p>
            <p>
              Early public-rate discussions considered approximately USD
              180–200. This was a positioning objective, not an achieved ADR.
              The verified stabilised ADR was USD 155.
            </p>
          </div>
      ...
      <section className="operations-revenue page-width">
        <OperationsHeading
          ...
          title="Each room was treated as perishable inventory."
        />
        <div className="operations-revenue-grid">
          <div>
            <p>
              An unsold room could not be recovered after the night passed. A
              room sold too cheaply could increase occupancy while reducing
              margin and future pricing power.
            </p>
            <p>
              Discounted group demand was assessed against the probability of
              selling the same inventory individually at a higher rate. The
              objective was the strongest combination of occupancy, rate and
              total hotel revenue.
            </p>
          </div>
          <div className="operations-revenue-factors">
            {revenueFactors.map((factor) => (
              <span key={factor}>{factor}</span>
            ))}
          </div>
        </div>
        <div
          className="operations-equation"
          aria-label="Operating performance relationship"
        >
          ...
          <b>=</b>
          <strong>Operating performance</strong>
        </div>
      </section>
      ...
      <section className="operations-demand">
        <div className="page-width">
          <OperationsHeading
            number="06"
            label="BUILDING THE DEMAND BASE"
            title="The hotel required both base occupancy and higher-rated demand."
          />
          ...
          <p className="operations-demand-note">
            Marriott supplied global and regional distribution, but
            property-specific demand still required dedicated local sales
            activity.
          </p>
        </div>
      </section>
      ...
      <section className="operations-opening page-width">
        <OperationsHeading
          number="07"
          label="A CONTROLLED OPENING"
          title="Initial occupancy created room to learn."
        />
        <div className="operations-opening-grid">
          <div className="operations-opening-stat">
            <strong>~18%</strong>
            <span>Occupancy around opening</span>
            <small>Narrative record</small>
          </div>
          <div>
            <p>
              The lower initial load functioned as an extension of
              commissioning. Problems could be identified and corrected before
              exposure to peak demand.
            </p>
            <div className="operations-opening-tests">
              {openingTests.map((test) => (
                <span key={test}>
      ...
      <section className="operations-issues">
        <div className="page-width operations-issues-grid">
          <div>
            <OperationsHeading
              number="08"
              label="EARLY OPERATING ISSUES"
              title="Real guests tested the complete system."
            />
            <p>
              A structured snagging process allowed operating and construction
              teams to resolve persistent engineering issues and smaller
              new-hotel defects concurrently.
            </p>
          </div>
          <div className="operations-issue-list">
            {earlyIssues.map((issue, index) => (
              <div key={issue}>
                <span>{String(index + 1).padStart(2, "0")}</span>
                <p>{issue}</p>
              </div>
      ...
      <section className="operations-section page-width operations-food">
        <OperationsHeading
          number="09"
          label="FOOD AND BEVERAGE OPERATIONS"
          title="Design intent had to translate into daily efficiency."
        />
        <div className="operations-section-copy">
          <p>
            Food and beverage was both a guest-experience requirement and a
            material operating business. The kitchen infrastructure supported
            separate storage and preparation functions; operational discipline
            determined the margin.
          </p>
          <div className="operations-food-grid">
            {foodPriorities.map((priority, index) => (
              <span key={priority}>
                <b>{String(index + 1).padStart(2, "0")}</b>
                {priority}
              </span>
          ...
          <p>
            Equipment positions, extraction, electrical connections and
            preparation workflows continued to be refined before and after
            opening.
          </p>
        </div>
      </section>
      ...
      <section className="operations-feedback">
        <div className="page-width">
          <OperationsHeading
            number="10"
            label="FEEDBACK AS AN OPERATING CONTROL"
            title="Guest response became part of quality management."
          />
          <div className="operations-feedback-grid">
            <div>
              <p>
                Reviews externally tested the development assumptions. Positive
                comments supported the central design decisions; recurring
                criticism identified service or maintenance failures requiring
                correction.
              </p>
            ...
            <div className="operations-feedback-loop">
              {feedbackLoop.map((step, index) => (
                <div key={step}>
                  <span>{String(index + 1).padStart(2, "0")}</span>
                  <strong>{step}</strong>
                  {index < feedbackLoop.length - 1 && <ArrowRight size={15} />}
                </div>
              ))}
            </div>
          </div>
      ...
      <section className="operations-ramp page-width">
        <OperationsHeading
          number="11"
          label="SCALING OCCUPANCY"
          title="The systems were tested again as demand increased."
        />
        <p className="operations-intro">
          Higher occupancy placed materially greater pressure on housekeeping,
          food production, elevators, hot water, laundry, maintenance,
          reservations, circulation, staffing and stock levels.
        </p>
        ...
        <p className="operations-ramp-note">
          A period of 100% occupancy demonstrated peak demand and tested
          capacity. It was not the stabilised occupancy rate, which required
      ...
      <section className="operations-performance">
        <div className="page-width">
          <OperationsHeading
            number="12"
            label="STABILISED PERFORMANCE"
            title="The operating case was established."
          />
          ...
          <p className="operations-performance-note">
            Together, rate, sustained demand and operating efficiency provided
            the evidence required to support valuation and an eventual
            transaction.
          </p>
        </div>
      </section>
      ...
      <section className="operations-governance page-width">
        <OperationsHeading
          number="13"
          label="OWNER AND OPERATOR ROLES"
          title="Brand management did not remove owner oversight."
        />
        <p className="operations-intro">
          Marriott managed the hospitality business. Ownership monitored asset
          performance against the investment case and retained responsibility
          for capital and strategy.
        </p>
        <div className="operations-governance-table">
          <div className="operations-table-head">
            <span>Operator responsibility</span>
            <span>Ownership responsibility</span>
          </div>
      ...
      <section className="operations-lessons page-width">
        <OperationsHeading
          number="14"
          label="OPERATING LESSONS"
          title="What the operating period established."
        />
      ...
      <section className="operations-close">
        <div className="page-width operations-close-grid">
          <div>
            ...
            <h2>
              Stabilisation converted development risk into operating evidence.
            </h2>
          </div>
          <div>
            <p>
              The hotel moved from a newly completed asset to a functioning
              resort with sustained occupancy, established pricing and a 38%
              gross operating profit margin.
            </p>
            <p>
              That record made the asset easier to value, finance and assess as
              an acquisition. The final development stage was determining when
              and how to exit.
            </p>
